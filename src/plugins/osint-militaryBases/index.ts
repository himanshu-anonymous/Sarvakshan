...
export class OsintMilitaryBasesPlugin implements WorldPlugin {
    id = "osint-militaryBases";
    name = "MIL BASES";
    description = "Public military installation locations.";
    icon = Layers;
...
export default OsintMilitaryBasesPlugin;\n