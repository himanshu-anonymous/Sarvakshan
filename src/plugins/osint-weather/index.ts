...
export class OsintWeatherPlugin implements WorldPlugin {
    id = "osint-weather";
    name = "WEATHER";
    description = "Global sampled weather field with alert merge.";
    icon = Layers;
...
export default OsintWeatherPlugin;\n