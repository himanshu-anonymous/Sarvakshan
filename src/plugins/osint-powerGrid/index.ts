...
export class OsintPowerGridPlugin implements WorldPlugin {
    id = "osint-powerGrid";
    name = "POWER GRID";
    description = "Real-time outage intelligence + global power infrastructure.";
    icon = Layers;
...
export default OsintPowerGridPlugin;\n