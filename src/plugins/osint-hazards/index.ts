...
export class OsintHazardsPlugin implements WorldPlugin {
    id = "osint-hazards";
    name = "HAZARDS";
    description = "General hazard overlays from open feeds.";
    icon = Layers;
...
export default OsintHazardsPlugin;\n