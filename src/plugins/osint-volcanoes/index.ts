...
export class OsintVolcanoesPlugin implements WorldPlugin {
    id = "osint-volcanoes";
    name = "VOLCANOES";
    description = "Volcanic activity and monitoring notices.";
    icon = Layers;
...
export default OsintVolcanoesPlugin;\n