...
export class OsintSpaceWeatherPlugin implements WorldPlugin {
    id = "osint-spaceWeather";
    name = "SPACE WX";
    description = "NOAA aurora probability model.";
    icon = Layers;
...
export default OsintSpaceWeatherPlugin;\n