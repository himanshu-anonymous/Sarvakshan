...
export class OsintConflictsPlugin implements WorldPlugin {
    id = "osint-conflicts";
    name = "CONFLICTS";
    description = "Open-source conflict and unrest event signals.";
    icon = Layers;
...
export default OsintConflictsPlugin;\n