...
export class OsintAirspacePlugin implements WorldPlugin {
    id = "osint-airspace";
    name = "AIRSPACE";
    description = "No-fly/restricted airspace overlays.";
    icon = Layers;
...
export default OsintAirspacePlugin;\n