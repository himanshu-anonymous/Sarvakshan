...
export class OsintMaritimePlugin implements WorldPlugin {
    id = "osint-maritime";
    name = "MARITIME";
    description = "Global port network + live AIS vessel tracking.";
    icon = Layers;
...
export default OsintMaritimePlugin;\n