...
export class OsintAirQualityPlugin implements WorldPlugin {
    id = "osint-airQuality";
    name = "AIR QUALITY";
    description = "Air quality indicators (AQI, PM2.5, ozone).";
    icon = Layers;
...
export default OsintAirQualityPlugin;\n