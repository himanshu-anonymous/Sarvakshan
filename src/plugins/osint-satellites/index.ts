...
export class OsintSatellitesPlugin implements WorldPlugin {
    id = "osint-satellites";
    name = "SATELLITES";
    description = "Orbiting satellites propagated from TLE feeds.";
    icon = Layers;
...
export default OsintSatellitesPlugin;\n