...
export class OsintFireHotspotsPlugin implements WorldPlugin {
    id = "osint-fireHotspots";
    name = "FIRE HOTSPOTS";
    description = "Active thermal fire detections from satellites.";
    icon = Layers;
...
export default OsintFireHotspotsPlugin;\n