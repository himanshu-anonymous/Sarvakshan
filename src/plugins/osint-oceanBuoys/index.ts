...
export class OsintOceanBuoysPlugin implements WorldPlugin {
    id = "osint-oceanBuoys";
    name = "OCEAN BUOYS";
    description = "Buoy observations: waves, wind, pressure, sea temp.";
    icon = Layers;
...
export default OsintOceanBuoysPlugin;\n