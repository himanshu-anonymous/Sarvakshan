...
export class OsintSeismicStationsPlugin implements WorldPlugin {
    id = "osint-seismicStations";
    name = "SEIS STATIONS";
    description = "Seismometer station network locations.";
    icon = Layers;
...
export default OsintSeismicStationsPlugin;\n